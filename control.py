...
def setLoc(coords):
  ...
  """
  while not <within 10 meters of target position>:
    time.sleep(1)
  """
...
def waitForSignal():
  pass
  """
  while not <get signal to liftoff and retrieve pod>:
    time.sleep(1)
  """
...
def main():
  ...
  returnHome()
  disarm()
  time.sleep(100) #however long it takes for the pod to finish scanning, in seconds
  waitForSignal() 
  start()
  findPod()
  returnHome()
